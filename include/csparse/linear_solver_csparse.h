#ifndef FBLOCKSOLVER_LINEAR_SOLVERCSPARSE_H
#define FBLOCKSOLVER_LINEAR_SOLVERCSPARSE_H

#include "csparse_helper.h"

#include "../base/linear_solver.h"
#include "../base/marginal_covariance_cholesky.h"
#include "fblock_solver_csparse_api.h"
 ...
 */
struct FBLOCKSOLVER_SOLVER_CSPARSE_API CSparseExt : public cs
{
  CSparseExt()
  {
    nzmax = 0;
